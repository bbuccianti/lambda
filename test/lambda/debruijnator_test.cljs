         ...
         {:param {:var "s" :index 2},
          ...
          {:abst
           {:param {:var "z" :index 1},
            :cuerpo
            {:apli
             {:opdor {:apli {:opdor {:var "x" :index 4}, :opndo {:var "s" :index 2}}},
              :opndo
              {:apli
               {:opdor {:apli {:opdor {:var "y" :index 3}, :opndo {:var "s" :index 2}}},
                :opndo {:var "z" :index 1}}}}}}}}}}}}}
  ...
  (are [exp act]
    ...
    {:apli
     {:opdor
      {:abst
       {:param {:var "x" :index 1},
        :cuerpo {:apli {:opdor {:var "x" :index 1}, :opndo {:var "x" :index 1}}}}},
      :opndo
      {:abst
       {:param {:var "x" :index 1},
        :cuerpo {:apli {:opdor {:var "x" :index 1}, :opndo {:var "x" :index 1}}}}}}}
    ...
    {:apli
     {:opdor
      ...
      {:abst
       {:param {:var "y" :index 1},
        :cuerpo {:apli {:opdor {:var "y" :index 1}, :opndo {:var "y" :index 1}}}}}}}
    "(λx.x x) (λy.y y)"
    ))
